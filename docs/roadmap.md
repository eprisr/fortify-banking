...
| **Secrets manager migration** | ⚪ Planned | *(new, ADR-016)* Plaid access tokens, Dwolla OAuth credentials, and any private keys move out of Appwrite document collections into Doppler or AWS Secrets Manager |
